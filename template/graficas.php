        ...
        <div class="container">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-xs-8">
                 <div class="row">
                 <form action="../conexion/graficar.php" method="get" role="form">
            ...
            <div class="container">
              <div class="row">
                ...
                <center>
                  ...
                  ?>
                  <br/><br/>
                  <form action="../conexion/resultado.php" method="get" role="form">
                  <!--<form role="form" onclick="estado()" name="frm">-->
                  ...
                  <?php
                    $profe = new Connection();
                    $table= $_GET['table'];
                    $profe->Graficar($ncontrol, $table, $user);
                  ?>
